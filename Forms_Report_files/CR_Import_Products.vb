...
Public Class CR_Import_Products
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ProjectRK.CR_Import_Products.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Import_Products
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Import_Products = New CR_Import_Products()
        rpt.Site = Me.Site
        Return rpt
    End Function
